class Game {
  ...
  play(){
    ...
    player.getFinishedPlayersCount();
    ...
    if(player.distance > 3860 &&crossedFinishedLine === false){
      finishedPlayers += 1
      player.updateFinishedPlayerCount(finishedPlayers)
